  ...
  return (
    <section className="relative section-padding pb-0">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center py-16 max-w-[1170px] mx-auto justify-center">
          {/* Left */}
          <div className="w-full lg:w-1/2 lg:pr-8 mb-10 lg:mb-0">
            <span
              className="relative pl-6 text-[14px] md:text-[16px] font-semibold text-primary-1 uppercase tracking-wider
            ...
            <h2 className="mt-4 mb-4 text-[28px] sm:text-[32px] md:text-[38px] lg:text-[42px] xl:text-[50px] font-bold text-primary-3 max-w-[500px]">
              Simplify Insurance Coverage Today
            </h2>

            <p className="mb-8 text-[15px] md:text-[16px] text-primary-5 max-w-[510px]">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 mb-10">
              <div className="flex items-center gap-4">
                <h2 className="xl:text-[50px] lg:text-[42px] md:text-[38px] sm:text-[32px] text-[28px] font-bold text-primary-5">
                  <span className="counter">89</span>k
                </h2>
                <h6 className="xl:text-[18px] lg:text-[16px] md:text-[14px] sm:text-[13px] text-[12px] font-semibold text-primary-6 max-w-[145px] capitalize">
