      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center py-16">
          ...
          <div className="w-full lg:w-1/2 lg:pr-8 mb-10 lg:mb-0">
            ...
            <p className="mb-8 text-gray-600 max-w-[510px]">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 mb-10">
              <div className="flex items-center gap-4">
                <h2 className="text-3xl font-bold text-gray-800"><span className="counter">89</span>k</h2>
                <h6 className="font-semibold text-base text-gray-600 max-w-[145px] capitalize">
                  Project Completed Last Years
                </h6>
              </div>
              <div className="flex items-center gap-4">
                <h2 className="text-3xl font-bold text-gray-800"><span className="counter">87</span>k</h2>
                <h6 className="font-semibold text-base text-gray-600 max-w-[145px] capitalize">
